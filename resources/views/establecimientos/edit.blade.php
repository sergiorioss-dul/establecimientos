            ...
            @method('put')
                <fieldset class="border p-4">
                        ...
                        <select class="form-control @error('categoria_id') is-invalid @enderror" name="categoria_id"
                            ...
                            @foreach ($categorias as $categoria)
                                <option value="{{ $categoria->id }}"
                                    {{ $establecimiento->categoria_id === $categoria->id ? 'selected' : '' }}>{{ $categoria->nombre }}
                                </option>
                            @endforeach
                        </select>
                    </div>
                    <div class="form-group">
                        ...
                        @enderror
                        <img src="/storage/{{ $establecimiento->imagen_principal }}" style="width: 200px; margin-top:20px" alt="Establecimiento">
                    </div>
                </fieldset>
